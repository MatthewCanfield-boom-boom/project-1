...
let football_player: Sprite = null
...
game.onUpdateInterval(1000, function () {
    football_player = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . e 2 2 2 2 2 . . . . . . 
        . . . e 2 2 d 2 2 2 2 . . . . . 
        . . . e 2 2 2 2 2 2 2 e . . . . 
        ...
        . . . . . . f f f f . . . . . . 
        `, SpriteKind.Enemy)
    football_player.setPosition(160, randint(5, 115))
    football_player.vx = -100
    ...
    football_player.setFlag(SpriteFlag.AutoDestroy, true)
})
